...
mongoose.connect(process.env.MONGO, {
  ...
  const Keyword = mongoose.model('Keyword', new Schema({ word: String, category: { type: Schema.Types.ObjectId, ref: 'Category' } }));
...
async function seedCategoriesAndKeywords() {
    ...
    const keywords = [
        { word: 'Helpful', category: savedCategories.find(c => c.name === 'Staff')._id },
        { word: 'Clean', category: savedCategories.find(c => c.name === 'Room')._id },
        // ... more keywords
    ];
